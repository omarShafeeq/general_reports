...
class BasicGridPage extends StatefulWidget {
  const BasicGridPage({super.key});

  @override
  State<BasicGridPage> createState() => _BasicGridPageState();
}

class _BasicGridPageState extends State<BasicGridPage> {
  late final List<Employee> _employees;
  late final _EmployeeDataSource _dataSource;

  @override
  void initState() {
    super.initState();
    _employees = HrDataGenerator.generateEmployees(count: 100);
    _dataSource = _EmployeeDataSource(_employees);
  }
  ...
  Widget build(BuildContext context) {
    return ResponsiveScaffold(
      ...
      currentRoute: RouteNames.basicGrid,
      body: GridWrapper(
